...
class ModLangProvider(
    ...
    override fun generateTranslations(
        ...
        translationBuilder.add("modmenu.carpeted-mod.line.tags", "Pack makers can adjust minecraft:wool_carpets, carpeted-mod:carpets/<color>, carpet_dyes, carpet_removers, and the carpeted-mod block behavior tags.")
        translationBuilder.add("modmenu.carpeted-mod.line.scope", "Version 1 registers carpeted variants for all vanilla slabs and stairs, while datapacks control item compatibility and behavior overrides.")
